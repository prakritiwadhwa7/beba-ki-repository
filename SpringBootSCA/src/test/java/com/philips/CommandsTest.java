...
public class CommandsTest {
	...
	public void getsecuritycommandTest() {
		...
		Commands.setProjectdir("C:\\Users");
		Commands.setProjectname("ExampleWebApp");
		final String[] expected = new String[] { "cmd", "/c", "VisualCodeGrepper.exe", "-c", "-l", "java", "-t",
				"C:\\Users", "--results", "C:\\Users" + "\\securityreport\\" + "ExampleWebApp" + ".txt" };
	...
	public void getjavaagentTest() {
		...
		final String[] expected = new String[] { "cmd", "/c", "java", "-cp",
				Commands.currentdir + "\\files\\junit-4.12.jar;" + Commands.currentdir
						+ "\\files\\hamcrest-core-1.3.jar;" + Commands.projectdir + "\\target\\test-classes;"
						+ Commands.projectdir + "\\target\\classes",
				"-javaagent:" + Commands.currentdir + "\\files\\jacocoagent.jar=destfile=" + Commands.currentdir
						+ "\\jacoco-report\\jacoco-" + Commands.projectname + ".exec",
	...
	public void getjavacommandTest() {
		...
		final String[] expected = new String[] { "cmd", "/c", "start", "java", "-jar",
				...
				Commands.projectdir + "\\target\\test-classes", "--sourcefiles", Commands.projectdir + "\\src",
				"--sourcefiles", Commands.projectdir + "\\target", "--csv",
	...
	public void getPmdCommandTest() {
		...
		Commands.setProjectdir("C:\\Users");
		Commands.setProjectname("ExampleWebApp");
		final String[] expected = new String[] { "cmd", "/c", "pmd", "-d", Commands.projectdir, "-f", "xml", "-R",
	...
	public void getcyviscommandTest() {
		...
		Commands.setProjectdir("C:\\Users");
		Commands.setProjectname("ExampleWebApp");
		final String[] expected = new String[] { "cmd", "/c", "cd", Commands.currentdir + "\\files\\cyvis-0.9", "&&",
				"jar", "cf", "jar1.jar", Commands.projectdir, "&&", "java", "-jar", "cyvis-0.9.jar", "-p", "jar1.jar",
				"-t", Commands.currentdir + "\\complexityreport\\" + Commands.projectname + ".txt" };
