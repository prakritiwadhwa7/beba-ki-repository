...
public class StaticToolController {
  ...
  @GetMapping("/security")
  public ToolResult securityVulnerabilities(@RequestParam("securityThreshold") String userconfig) throws IOException, InterruptedException {
  ...
  @GetMapping("/warnings")
  public ToolResult staticWarnings(@RequestParam("warningThreshold") String userconfig) throws Exception {
  ...
  public ToolResult getComplexity(@RequestParam("complexityThreshold") String userconfig) throws IOException, InterruptedException {
